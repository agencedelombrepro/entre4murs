...
const cityData: Record<string, {
  ...
  laigle: {
    ...
    intro: "Basé au cœur de L'Aigle, Entre 4 Murs accompagne les particuliers et professionnels dans leurs projets de peinture, placo et rénovation intérieure. Connaissance approfondie du bâti local, des matériaux adaptés au climat normand, et une approche sur-mesure pour chaque chantier. Premier artisan contacté à L'Aigle ? Vous avez fait le bon choix.",
    ...
    faq: [
      ...
      { question: "Quel est le délai pour un devis à L'Aigle ?", answer: "Nous nous engageons à vous fournir un devis détaillé sous 48h maximum après visite sur site. Pour les chantiers urgents à L'Aigle, nous pouvons souvent intervenir plus rapidement." },
      { question: "Quels types de bâtiments rénovez-vous à L'Aigle ?", answer: "Nous intervenons sur tous types de bâtiments : maisons de ville anciennes, pavillons récents, appartements, commerces, et locaux professionnels. Chaque projet bénéficie d'une approche adaptée." },
      { question: "Proposez-vous des conseils pour la rénovation énergétique ?", answer: "Absolument. Nous vous orientons vers les solutions de peinture et d'isolation adaptées pour améliorer les performances thermiques de votre habitat, tout en respectant le caractère du bâti ancien si nécessaire." },
    ],
  },
  verneuil: {
  ...
  aube: { name: "Aube", displayName: "Aube", department: "Orne", postalCode: "61270", population: "1 400", description: "Village rural de l'Orne, Aube conserve un charme authentique avec ses maisons en pierre.", localChallenges: ["Rénovation de maisons anciennes en pierre", "Ravalement respectueux du bâti traditionnel", "Aménagement de granges et dépendances", "Peinture sur supports anciens"], localProjects: ["Rénovation d'une maison de village", "Transformation d'une grange en habitation", "Ravalement de façade en pierre", "Peinture intérieure d'une longère rénovée"], seoTitle: "Peintre Aube (61270) | Rénovation Maisons Pierre Orne | Entre 4 Murs", metaDescription: "Artisan peintre à Aube (61). Rénovation maisons en pierre, longères. Proche de L'Aigle. Devis gratuit.", h1: "Artisan peintre à Aube", intro: "Village par village, Entre 4 Murs construit sa réputation dans l'Orne. À Aube, nous intervenons sur tous types de chantiers avec le même engagement qualité.", heroPhoto: "/images/chantier-15.jpg", faq: [{ question: "Travaillez-vous dans les petits villages ?", answer: "Oui, absolument. Aube fait partie intégrante de notre zone d'intervention. La taille du village ou l'éloignement n'influencent pas notre tarification de base." }, { question: "Comment respectez-vous le cachet des maisons anciennes ?", answer: "Nous utilisons des techniques et matériaux compatibles avec le bâti ancien : chaux, peintures minérales, préparation soignée des supports." }, { question: "Pouvez-vous transformer des dépendances ?", answer: "Oui, nous participons à l'aménagement de granges, anciennes étables ou autres dépendances." }, { question: "Quel budget prévoir pour une maison de village ?", answer: "Cela dépend de nombreux critères. Nous établissons systématiquement un devis détaillé gratuit après visite." }] },
  crulai: { name: "Crulai", displayName: "Crulai", department: "Orne", postalCode: "61300", population: "450", description: "Petit village de l'Orne au patrimoine rural préservé, à quelques minutes de L'Aigle.", localChallenges: ["Rénovation de maisons de campagne isolées", "Restauration du bâti ancien", "Travaux sur dépendances agricoles", "Respect de l'authenticité rurale"], localProjects: ["Rénovation d'une ancienne fermette", "Ravalement d'une maison de campagne", "Peinture d'un corps de ferme rénové", "Aménagement d'une dépendance"], seoTitle: "Peintre Crulai (61300) | Rénovation Maisons Campagne | Entre 4 Murs", metaDescription: "Artisan peintre à Crulai (61300). Très proche de L'Aigle. Rénovation maisons campagne. Devis gratuit.", h1: "Peintre à Crulai et alentours", intro: "Dans les petits villages comme Crulai, Entre 4 Murs apporte son expertise et sa disponibilité. Nous aimons les chantiers ruraux où la qualité du travail fait toute la différence.", heroPhoto: "/images/chantier-01.jpg", faq: [{ question: "Vous déplacez-vous vraiment dans les petits villages ?", answer: "Oui, sans aucun problème. Crulai fait partie de notre secteur habituel, à quelques minutes de notre base à L'Aigle." }, { question: "Comment gérez-vous les chantiers isolés ?", answer: "Nous organisons nos chantiers de manière efficace, en prévoyant les approvisionnements à l'avance. Vous ne payez pas le prix de l'isolement." }, { question: "Travaillez-vous sur les anciennes fermes ?", answer: "Oui, c'est un type de projet que nous maîtrisons bien. Réhabilitation complète ou simple rafraîchissement, nous adaptons notre intervention." }, { question: "Pouvez-vous conseiller sur les couleurs pour une maison de campagne ?", answer: "Absolument. Nous vous orientons vers des teintes harmonieuses avec l'environnement rural, en tenant compte de l'architecture et de vos goûts." }] },
  chandai: { name: "Chandai", displayName: "Chandai", department: "Orne", postalCode: "61300", population: "550", description: "Village normand typique, Chandai offre un cadre rural paisible à proximité immédiate de L'Aigle.", localChallenges: ["Rénovation de maisons de village", "Ravalement de façades traditionnelles", "Transformation de bâtiments agricoles", "Mise en valeur des matériaux locaux"], localProjects: ["Rénovation d'une maison de village", "Peinture d'une grange aménagée", "Ravalement d'une façade en pierre et torchis", "Aménagement de combles"], seoTitle: "Peintre Chandai (61300) | Artisan Rénovation Village | Entre 4 Murs", metaDescription: "Artisan peintre à Chandai (61). Proche de L'Aigle. Rénovation maisons village, peinture, placo. Devis gratuit.", h1: "Peintre à Chandai : artisan de confiance", intro: "Proche de L'Aigle, Chandai bénéficie de notre réactivité et de notre connaissance du territoire ornais. Entre 4 Murs vous accompagne avec professionnalisme et proximité.", heroPhoto: "/images/chantier-01.jpg", faq: [{ question: "Quelle est votre zone d'intervention autour de Chandai ?", answer: "Chandai étant très proche de L'Aigle, nous intervenons très rapidement. Devis sous 24h, intervention possible dans la semaine." }, { question: "Travaillez-vous en toute saison ?", answer: "Les travaux intérieurs peuvent être réalisés toute l'année. Pour l'extérieur, nous privilégions la période d'avril à octobre." }, { question: "Comment assurez-vous la propreté du chantier ?", answer: "Nous protégeons systématiquement les sols et le mobilier, nettoyons quotidiennement, et effectuons un nettoyage final complet." }, { question: "Proposez-vous un paiement échelonné ?", answer: "Pour les chantiers importants, oui. Nous établissons un échéancier de paiement en fonction de l'avancement." }] },
  moulins: { name: "Moulins-la-Marche", displayName: "Moulins-la-Marche", department: "Orne", postalCode: "61380", population: "800", description: "Bourg rural de l'Orne, Moulins-la-Marche combine habitat traditionnel et développement pavillonnaire récent.", localChallenges: ["Rénovation de maisons de bourg", "Peinture de pavillons récents", "Ravalement de commerces et bâtiments publics", "Harmonisation ancien/moderne"], localProjects: ["Rénovation d'une maison de bourg", "Peinture intérieure d'un pavillon", "Ravalement de façade centre-bourg", "Aménagement intérieur d'une maison rénovée"], seoTitle: "Peintre Moulins-la-Marche | Peinture & Ravalement | Entre 4 Murs", metaDescription: "Artisan peintre à Moulins-la-Marche (Orne). Peinture, placo, rénovation. Devis gratuit.", h1: "Artisan peintre à Moulins-la-Marche", intro: "À Moulins-la-Marche, Entre 4 Murs intervient sur tous types de bâtiments avec le même engagement de qualité artisanale.", heroPhoto: "/images/chantier-03.jpg", faq: [{ question: "Intervenez-vous pour les professionnels ?", answer: "Oui, nous travaillons aussi bien pour des particuliers que pour des artisans, commerçants, ou collectivités locales." }, { question: "Pouvez-vous intervenir rapidement en cas d'urgence ?", answer: "Pour les urgences (dégât des eaux, sinistre), nous faisons notre maximum pour intervenir rapidement. Contactez-nous directement." }, { question: "Quelle garantie offrez-vous ?", answer: "Tous nos chantiers sont couverts par notre assurance décennale. Nous garantissons également la qualité de nos prestations." }, { question: "Comment se déroule un chantier type ?", answer: "Visite et devis gratuits, planification ensemble, protection des lieux, réalisation, nettoyage final, réception avec vous." }] },
  longny: { name: "Longny-les-Villages", displayName: "Longny-les-Villages", department: "Orne", postalCode: "61290", population: "1 500", description: "Commune nouvelle regroupant plusieurs villages du Perche ornais, Longny-les-Villages offre un territoire étendu avec un patrimoine bâti diversifié.", localChallenges: ["Rénovation dispersée sur plusieurs hameaux", "Restauration de maisons percheronnes", "Transformation de corps de ferme", "Respect du patrimoine du Perche"], localProjects: ["Rénovation d'une maison percheron", "Peinture d'un corps de ferme aménagé", "Ravalement de maisons de village", "Aménagement de dépendances"], seoTitle: "Peintre Longny-les-Villages | Rénovation Perche 61 | Entre 4 Murs", metaDescription: "Artisan peintre à Longny-les-Villages (Orne). Spécialiste Perche ornais. Peinture, placo, rénovation. Devis gratuit.", h1: "Peintre à Longny-les-Villages et villages associés", intro: "Dans le Perche ornais, Entre 4 Murs couvre l'ensemble de Longny-les-Villages et ses villages associés. Notre connaissance du territoire garantit votre satisfaction.", heroPhoto: "/images/chantier-15.jpg", faq: [{ question: "Couvrez-vous tous les villages de la commune nouvelle ?", answer: "Oui, nous intervenons dans tous les villages qui composent Longny-les-Villages. Notre rayon d'action couvre largement ce territoire." }, { question: "Connaissez-vous les maisons percheronnes ?", answer: "Oui, nous avons l'habitude de travailler sur le patrimoine typique du Perche. Nous connaissons les matériaux traditionnels et les techniques adaptées." }, { question: "Peut-on vous contacter pour un simple conseil ?", answer: "Absolument. Nous sommes disponibles pour vous conseiller gratuitement, même si vous n'êtes pas encore décidé." }, { question: "Quel est votre engagement qualité ?", answer: "Travaux conformes aux normes DTU, assurance décennale, aucune sous-traitance, suivi personnalisé. Notre signature depuis 2010." }] },
};
    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--off-white)" }}>
      ...
      <section className="relative pt-20 overflow-hidden">
        <div className="grid lg:grid-cols-2 min-h-[60vh]">
          {/* Left — Navy */}
          <div
            className="flex flex-col justify-end px-8 md:px-12 lg:px-16 py-16 lg:pt-24"
          ...
          >
            ...
            >
              ...
              <p className="text-sm leading-relaxed mb-8 max-w-lg" style={{ color: "rgba(255,255,255,0.6)" }}>
                {data.intro}
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3.5 text-sm font-semibold text-white transition-all"
                ...
                <motion.a
                  href="#contact"
                  whileHover={{ scale: 1.02 }}
                  className="inline-flex items-center justify-center gap-2 px-6 py-3.5 text-sm font-medium transition-all"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-5" style={{ fontFamily: "var(--font-serif)", color: "var(--navy)" }}>
              ...
              <ul className="space-y-3">
                {data.localChallenges.map((challenge) => (
                  <li key={challenge} className="flex items-start gap-3">
                    <CheckCircle2 size={17} style={{ color: "var(--terracotta)", flexShrink: 0, marginTop: 2 }} />
            ...
            <motion.div
              ...
              transition={{ duration: 0.7 }}
            >
              <h3 className="text-2xl font-bold mb-6" style={{ fontFamily: "var(--font-serif)", color: "var(--navy)" }}>
              ...
              <div className="space-y-3">
                {data.localProjects.map((project) => (
                  ...
                  >
                    <div className="w-2 h-2 mt-1.5 rounded-full flex-shrink-0" style={{ backgroundColor: "var(--terracotta)" }} />
      ...
      {/* FAQ */}
      <section className="py-20" style={{ backgroundColor: "var(--beige-light)" }}>
        <div className="max-w-3xl mx-auto px-6">
          ...
          >
            <h2 className="text-3xl font-bold" style={{ fontFamily: "var(--font-serif)", color: "var(--navy)" }}>
              Questions fréquentes · {data.displayName}
            </h2>
          </motion.div>
          <div>
            {data.faq.map((item) => (
      ...
      <section className="py-16" style={{ backgroundColor: "var(--white)" }}>
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-2xl font-bold mb-3" style={{ fontFamily: "var(--font-serif)", color: "var(--navy)" }}>
            Tous nos services à {data.displayName}
          </h2>
          <p className="text-sm mb-8" style={{ color: "var(--text-mid)" }}>
            Peinture intérieure, extérieure, placo, rénovation complète, ravalement — découvrez toute notre expertise.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/#services">
              <motion.button
                whileHover={{ scale: 1.02 }}
                className="px-7 py-3.5 text-sm font-semibold text-white transition-all"
                style={{ backgroundColor: "var(--navy)" }}
              >
            ...
            <Link to="/">
              <motion.button
                whileHover={{ scale: 1.02 }}
                className="px-7 py-3.5 text-sm font-semibold transition-all"
