  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 80% 60% at 50% 100%, rgba(201,98,60,0.09) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute top-[2.75rem] left-[calc(12.5%+2.25rem)] right-[calc(12.5%+2.25rem)] hidden lg:block pointer-events-none">
            <svg width="100%" height="2" viewBox="0 0 1000 2" preserveAspectRatio="none" overflow="visible">
              <motion.path
                d="M 0,1 L 1000,1"
                stroke="rgba(201,98,60,0.45)"
                strokeWidth="1"
                strokeDasharray="7 5"
                fill="none"
              ...
              <div key={step.number} className="flex flex-col items-center text-center">
                ...
                <div className="relative mb-8">
                  ...
                  <motion.div
                    ...
                    animate={isInView ? { scale: [1, 1.25, 1], opacity: [0.5, 0, 0.5] } : {}}
                    transition={{
                      duration: 2.8,
                      delay: 1.4 + i * 0.25,
                      repeat: Infinity,
                  ...
                  <motion.div
                    ...
                    transition={{ type: "spring", stiffness: 260, damping: 18, delay: 0.7 + i * 0.18 }}
                ...
                >
                  {/* Ghost number — slightly more visible */}
                  <div
                  ...
                  {/* Description — contrast corrigé : 0.48 → 0.72 */}
                  <p
